...
fun HostListScreen(
    ...
    HostListScreenContent(
        ...
        onNavigateToSettingsHighlightPersistConn = onNavigateToSettingsHighlightPersistConn,
        ...
        onShowNotificationSnackbar = onShowNotificationSnackbar,
        modifier = modifier,
    )
}
...
fun HostListScreenContent(
    ...
    val currentOnNavigateToSettingsHighlightPersistConn by rememberUpdatedState(onNavigateToSettingsHighlightPersistConn)
    val currentOnNotificationSnackbarShown by rememberUpdatedState(onShowNotificationSnackbar)
    ...
    LaunchedEffect(Unit) {
        if (currentShouldShowNotificationWarning()) {
            ...
            if (result == SnackbarResult.ActionPerformed) {
                currentOnNavigateToSettingsHighlightPersistConn()
            }
            currentOnNotificationSnackbarShown()
        }
    }
                ...
                uiState.hosts.isEmpty() -> {
                    ...
                    LazyColumn(
                        ...
                        itemsIndexed(
                            ...
                            if (index < uiState.hosts.lastIndex) {
                                HorizontalDivider()
                            }
                        }
                    }
